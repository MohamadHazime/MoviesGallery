...
{
    public class GetMovieDetailsHandler : IRequestHandler<GetMovieDetailsQuery, ShowDetailsDTO>
    {
        ...
        public async Task<ShowDetailsDTO> Handle(GetMovieDetailsQuery request, CancellationToken cancellationToken)
        {
